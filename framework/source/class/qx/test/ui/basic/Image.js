...
console.log(qx.$$resources);
      ...
      image.setWidth(20);
      this.assertEquals("40px", el.getStyle("font-size"));

      // Scale
      image.setScale(true);
      this.assertEquals("20px", el.getStyle("font-size"));

      image.setWidth(30);
      this.assertEquals("30px", el.getStyle("font-size"));
